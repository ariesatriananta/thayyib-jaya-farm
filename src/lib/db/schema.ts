...
export const recordings = pgTable("recordings", {
  ...
  feedPriceKg: real("feed_price_kg").notNull().default(0),
  feedRemainingKg: real("feed_remaining_kg").notNull(),
  feedUsedKg: real("feed_used_kg").notNull(),
  eggsKg: real("eggs_kg").notNull(),
  eggsPriceKg: real("eggs_price_kg").notNull().default(0),
  eggsCount: integer("eggs_count").notNull(),
  whiteEggsKg: real("white_eggs_kg").notNull().default(0),
  whiteEggsCount: integer("white_eggs_count").notNull().default(0),
  brokenEggsCount: integer("broken_eggs_count").notNull().default(0),
