          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <p className="font-medium">Mock (In-Memory)</p>
              </div>
            </div>
            <Separator />
            <p className="text-sm text-muted-foreground">
              Aplikasi ini menggunakan mock data. Untuk integrasi database nyata, 
              ganti service layer di <code className="bg-muted px-1 rounded">src/lib/services/</code> dengan 
              implementasi Prisma/Drizzle + Neon.
            </p>
          </CardContent>
        </Card>
      </div>
